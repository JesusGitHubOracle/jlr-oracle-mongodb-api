...
DEFINE demo_user = shop
DEFINE demo_schema = SHOP
DEFINE ords_url_mapping = orders
 

ACCEPT admin_password CHAR DEFAULT 'DB23ee###12345' PROMPT 'ADMIN password [default: DB23ee###12345]: ' HIDE
ACCEPT demo_password CHAR DEFAULT 'DB23ee###12345' PROMPT 'SHOP password [default: DB23ee###12345]: ' HIDE
